"""Tests for the Karnataka KEA state source contract."""
...
def test_contract_identity_seat_matrix() -> None:
    ...
    assert contract.source_id == "mcc_state_karnataka"
...
def test_contract_is_registerable() -> None:
    ...
    fetched = registry.get_contract("mcc_state_karnataka", "seat_matrix")
