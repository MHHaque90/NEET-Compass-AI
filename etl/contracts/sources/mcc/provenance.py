"""Provenance: deterministic file identity and SHA-256 checksums.

Two files from MCC describing the same cohort must hash to the same
...
stable identifier, regardless of when ingestion ran.
"""
