"""Uttar Pradesh NEET UG ingestion pipelines: contract -> validate -> transform -> persist.
...
from etl.contracts.sources.uttar_pradesh.parsers import parse_csv
...
def ingest_seat_matrix(
    ...
    *,
    ...
    """Ingest a Uttar Pradesh seat-matrix CSV through the full pipeline."""
    return _ingest(
        path,
        registry,
        loader,
...
def ingest_allotments(
    ...
    *,
    ...
    """Ingest a Uttar Pradesh allotment CSV through the full pipeline."""
    return _ingest(
        path,
        registry,
        loader,
