"""Karnataka KEA ingestion pipelines: contract -> validate -> transform -> persist.
...
from etl.contracts.sources.karnataka.parsers import parse_csv
...
def ingest_seat_matrix(
    ...
    *,
    ...
    """Ingest a Karnataka KEA seat-matrix CSV through the full pipeline."""
    return _ingest(
        path,
        registry,
        loader,
...
def ingest_allotments(
    ...
    *,
    ...
    """Ingest a Karnataka KEA allotment CSV through the full pipeline."""
    return _ingest(
        path,
        registry,
        loader,
