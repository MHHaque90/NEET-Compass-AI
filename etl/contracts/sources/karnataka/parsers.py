"""Parsers that turn Karnataka KEA source material into rows.
...
the Karnataka KEA contract expects. This mirrors the shape used by the MCC
``parse_csv`` so downstream the rows look identical to contract validation.
"""
