"""Karnataka KEA provenance: deterministic file identity and SHA-256 checksums.

Two files from KEA describing the same cohort must hash to the same checksum so
