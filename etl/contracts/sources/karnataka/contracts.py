"""Karnataka KEA source contracts.
    ...
    rules: list[ValidationRule] = [
        *_required("college_id", "course_id", "quota_id", "category_id", "total_seats"),
        ...
        ValidationRule(
            "category_id",
            "enum",
            {"values": ["gn", "bc", "ew", "sc", "st", "gn_pwd",
                         "bc_pwd", "ew_pwd", "sc_pwd", "st_pwd"]},
        ),
...
def seat_matrix_2026_contract() -> SourceContract:
    """Contract for the Karnataka KEA 2026 seat-matrix data.
...
def allotments_2026_contract() -> SourceContract:
    """Contract for the Karnataka KEA 2026 allotment-result data.

    Declares the non-PII columns the Karnataka KEA publishes in its
